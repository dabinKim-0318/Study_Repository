...
class RecyclerViewAdapter(val rv: RecyclerView) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    var count = -1
...
/*    override fun getItemViewType(position: Int): Int {
    ...
    inner class Item2ViewHolder(var binding: ItemBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind() {
